...
public class ConfigurationResource2
{
	/**
    ...
    public Response getConfigurationById(@PathParam("id") Integer id){
        ...
        if(config != null){
            UriBuilder builder = UriBuilder.fromResource(ConfigurationResource2.class)
                    						.path(ConfigurationResource2.class, "getConfigurationById");
