...
import com.se.sample.utils.Validator;
...
public class Task {
    ...
    public static class TaskBuilder {
        ...
        private TaskBuilder(String title, String description) {
            Validator.validateArgNotNullOrBlank(title, "title");
            Validator.validateArgNotNullOrBlank(description, "description");
        ...
        public TaskBuilder withIdentifier(String identifier) {
            Validator.validateArgNotNullOrBlank(identifier, "identifier");
        ...
        public TaskBuilder withCreatedAt(Instant createdAt) {
            Validator.validateArgNotNull(createdAt, "createdAt");
